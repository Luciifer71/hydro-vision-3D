...
export default function ConfidenceSlider() {
  const confidenceThreshold = useStore(state => state.confidenceThreshold ?? 0.20);
  ...
  return (
    <div className="bf-fieldset">
      <div className="bf-badge-title">
        ...
        AI SENSITIVITY GATE: {(confidenceThreshold * 100).toFixed(0)}%
      </div>
      ...
      <div style={{ marginTop: 6 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.62rem', color: 'var(--text-faint)', marginTop: 6, fontFamily: 'var(--font-mono)' }}>
          ...
          <span style={{ color: 'var(--amber)', fontWeight: 700 }}>CONF: {confidenceThreshold.toFixed(2)}</span>
